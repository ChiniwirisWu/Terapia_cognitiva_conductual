...
import { FontColorsType } from '@constants/constants';
  ...
  return (
    <div className="flex bg-gray-500/15 p-1 rounded-lg relative z-0">
      <BackdropEffectContext.Provider value={{ handleMouseEnter, handleMouseOut }}>
        <Button title={PageRoutes.blueprints} selected={pageRouteSelected} setSelected={setPageRouteSelected} textColor={textColor} />
        <Button title={PageRoutes.logs} selected={pageRouteSelected} setSelected={setPageRouteSelected} textColor={textColor} />
