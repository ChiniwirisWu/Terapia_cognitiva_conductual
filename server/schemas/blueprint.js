import z from "zod";
import { creenciasEnum, distorsionesEnum, emocionesEnum } from "./blueprintEnums.js";


const blueprintSchema = z.object({
  suceso_transtornador: z.string()
    .trim()
    .min(1, { message: "El suceso transtornador no puede estar vacio" })
  ...
  distorsiones_cognitivas: z.array(distorsionesEnum)
    .nonempty({ message: "Debes seleccionar al menos una disonasia cognitiva" }),
...
export function validatePartialBlueprint(input) {
